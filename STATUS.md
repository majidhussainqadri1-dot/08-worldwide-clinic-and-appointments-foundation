...
**Runtime `1.0.0` — complete 2026 master-plan source candidate, automatically verified and reproducibly packaged; external Hostinger staging and production acceptance remain pending.**
...
- Versioned availability rules and exceptions, DST-safe slot projection and atomic expiring holds.
...
- Optimistic versions, resource locks, collision prevention, replay resistance and immutable audit events.
- Appointment-processing consent separated from clinical treatment, publication, research and AI consent.
- Emergency diversion, review eligibility, private calendar export, conditional payment-intent reference, complaint/case reference and notification outbox boundaries.
...
- Responsive, RTL-aware and accessibility-oriented public/admin surfaces.
...
- master-plan static traceability checks;
...
- temporary governed artifact upload.
