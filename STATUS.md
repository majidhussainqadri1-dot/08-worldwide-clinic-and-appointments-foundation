...
## Second fresh 10-round corrective audit

A second sequential 10-round review-and-correct cycle was opened after the v1.2.1 closure. Findings are corrected before the next review proceeds. This cycle adds or strengthens:
...
- version/documentation alignment for runtime candidate 1.2.2 while retaining core schema 3.1.0, continuity schema 1.1.0 and Future24 schema 1.0.0.
...
| Coded | **Corrected candidate** — second-cycle source corrections are present. |
...
Do not promote this candidate to Packaged or Automated-QA Green using any older v1.2.1 artifact. Rebuild and reverify from the exact final HEAD.
