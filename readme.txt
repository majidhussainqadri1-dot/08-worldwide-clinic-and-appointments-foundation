...
2. Install the exact CI-generated 1.0.1 candidate on staging.
...
Protected routes use no-store/noindex controls. Public clinic output is allow-listed and uses opaque references. Appointment, patient, contact, clinical-like, native-identifier and private-note data are excluded. Export, erasure, retention and legal-hold controls are provided. Uninstall is non-destructive by default.

== Changelog ==

= 1.0.1 =
* Four plan-governed review rounds: clinic approval gate, actor/guardian binding, opaque public scheduling references, server-authoritative slot holds, purpose-limited administrative access, cross-clinic ownership checks, atomic compensation-safe rescheduling, expiring review eligibility, and expanded regression evidence.
