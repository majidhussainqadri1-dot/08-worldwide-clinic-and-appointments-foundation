...
2. Download the exact CI-generated File 08 v1.2.15 candidate whose manifest commit, artifact digest, and detached SHA-256 match the approved repository HEAD.
...
= 1.2.15 =
* T26 is the current review sequence. T26 R1 and R10 were defect-bearing and corrected only after their frozen ledgers; R2–R9 were clean. R1 aligned Public Clinic runtime/canonical contract 1.1.0 and hardened builder/verifier parity; R10 corrected release-currentness and historical-regression drift. Any corrected HEAD requires its own exact-head CI/package proof.
* Historical T25 R1–R10 is closed: R1, R8, R9 and R10 were defect-bearing/corrected; R2–R7 were clean. Historical T24 corrected uncertain-transaction idempotency replay boundaries and release-currentness drift; T21–T23 remain frozen provenance rather than current release identity.
...
* Runtime 1.2.15; current core schema is 3.4.0, continuity schema 1.1.0, and Future24 schema/contract 1.1.0. Historical earlier cycle evidence does not substitute for the current exact-head package/CI evidence; staging/live acceptance remains a separate gate and is not claimed by repository evidence.
