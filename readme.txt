...
2. Download the exact CI-generated File 08 v1.2.10 candidate whose manifest commit, artifact digest, and detached SHA-256 match the approved repository HEAD.
