...
$checks = array(
    'plain nonce-protected calendar export anchors retired' => false === strpos( $front, "appointment-refs/' . rawurlencode" ) || false === strpos( $front, "/calendar.ics' )" ),
    ...
    'patient projection consumes stored timezone' => false !== strpos( $front, "(string) ( $item['timezone'] ?? 'UTC' )" ),
    'legacy detail card consumes stored patient timezone' => false !== strpos( $front, "meta( $id, 'patient_timezone', 'UTC' )" ),
