...
if ( $administrator ) {
	foreach ( array( 'manage_worldwide_clinic', 'manage_wca_clinics', 'manage_wca_complaints', 'manage_wca_operations', 'read_swc_appointment', 'read_private_swc_appointments', 'edit_swc_appointments', 'edit_others_swc_appointments', 'publish_swc_appointments', 'delete_swc_appointments', 'delete_others_swc_appointments' ) as $capability ) {
