...
r10has('plugin readme current runtime',$readme,'Stable tag: 1.2.6');
r10has('repo readme current runtime',$repo_readme,'Runtime candidate: **1.2.6**');
r10has('status current runtime',$status,'Runtime candidate: **1.2.6**');
r10has('changelog current runtime',$changelog,'## 1.2.6 — 2026-08-11');
