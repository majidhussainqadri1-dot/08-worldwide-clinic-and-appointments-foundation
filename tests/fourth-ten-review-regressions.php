...
t410has('plugin 1.2.9',$bootstrap,'Version: 1.2.9');
t410has('runtime 1.2.9',$contracts,"RUNTIME_VERSION                 = '1.2.9'");
t410has('core schema 3.2.0',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
t410has('readme 1.2.7',$readme,'Stable tag: 1.2.9');
t410has('repo readme 1.2.7',$repo_readme,'Runtime candidate: **1.2.9**');
t410has('status 1.2.9',$status,'Runtime candidate: **1.2.9**');
t410has('changelog 1.2.9',$changelog,'## 1.2.7 — 2026-08-11');
