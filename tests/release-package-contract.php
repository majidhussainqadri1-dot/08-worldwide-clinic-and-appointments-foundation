...
f08pkg_has('builder',$builder,'wca_build_class_constant');
...
f08pkg_has('builder',$builder,"'core_schema_version' => wca_build_class_constant");
f08pkg_has('builder',$builder,"'continuity_schema_version' => wca_build_class_constant");
f08pkg_has('builder',$builder,"'future24_schema_version' => wca_build_class_constant");
...
f08pkg_has('verifier',$verifier,'Manifest policy/commit/schema mismatch.');
f08pkg_has('verifier',$verifier,'Manifest/runtime source parity failed:');
...
echo "Release-package runtime/commit/schema parity assertions passed: {$checks}/{$checks}.\n";
