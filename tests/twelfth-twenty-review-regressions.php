...
t12_has('release plugin 1.2.13','worldwide-clinic.php','Version: 1.2.14');
t12_has('release runtime constant 1.2.13','includes/class-wca-contracts.php',"RUNTIME_VERSION                 = '1.2.14'");
