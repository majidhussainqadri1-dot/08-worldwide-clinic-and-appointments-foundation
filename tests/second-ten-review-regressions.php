...
s210has('plugin header 1.2.4',$bootstrap,'Version: 1.2.4');
s210has('runtime constant 1.2.4',$bootstrap,"WCA_VERSION', '1.2.4");
s210has('contract runtime 1.2.4',$contracts,"RUNTIME_VERSION                 = '1.2.4'");
s210has('core schema unchanged',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
s210has('readme stable 1.2.4',$readme,'Stable tag: 1.2.4');
s210has('repository readme 1.2.4',$repo_readme,'Runtime candidate: **1.2.4**');
s210has('status 1.2.4',$status,'Runtime candidate: **1.2.4**');
s210has('changelog 1.2.4',$changelog,'## 1.2.4 — 2026-08-11');
