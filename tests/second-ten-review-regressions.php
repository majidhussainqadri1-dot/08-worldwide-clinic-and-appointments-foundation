...
s210has('plugin header 1.2.5',$bootstrap,'Version: 1.2.5');
s210has('runtime constant 1.2.5',$bootstrap,"WCA_VERSION', '1.2.5");
s210has('contract runtime 1.2.5',$contracts,"RUNTIME_VERSION                 = '1.2.5'");
s210has('core schema unchanged',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
s210has('readme stable 1.2.5',$readme,'Stable tag: 1.2.5');
s210has('repository readme 1.2.5',$repo_readme,'Runtime candidate: **1.2.5**');
s210has('status 1.2.5',$status,'Runtime candidate: **1.2.5**');
s210has('changelog 1.2.5',$changelog,'## 1.2.5 — 2026-08-11');
