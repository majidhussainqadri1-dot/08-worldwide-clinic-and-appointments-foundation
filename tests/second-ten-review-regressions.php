...
s210has('plugin header 1.2.6',$bootstrap,'Version: 1.2.6');
s210has('runtime constant 1.2.6',$bootstrap,"WCA_VERSION', '1.2.6");
s210has('contract runtime 1.2.6',$contracts,"RUNTIME_VERSION                 = '1.2.6'");
s210has('core schema unchanged',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
s210has('readme stable 1.2.6',$readme,'Stable tag: 1.2.6');
s210has('repository readme 1.2.6',$repo_readme,'Runtime candidate: **1.2.6**');
s210has('status 1.2.6',$status,'Runtime candidate: **1.2.6**');
s210has('changelog 1.2.6',$changelog,'## 1.2.6 — 2026-08-11');
