...
foreach(array('Version: 1.2.12',"WCA_VERSION', '1.2.12'") as $t){ r80has('bootstrap runtime',$bootstrap,$t); }
r80has('contract runtime',$contracts,"RUNTIME_VERSION                 = '1.2.12'"); r80has('readme runtime',$readme,'Stable tag: 1.2.12');
