...
foreach(array('Version: 1.2.14',"WCA_VERSION', '1.2.14'") as $t){ r80has('bootstrap runtime',$bootstrap,$t); }
r80has('contract runtime',$contracts,"RUNTIME_VERSION                 = '1.2.14'"); r80has('readme runtime',$readme,'Stable tag: 1.2.14');
