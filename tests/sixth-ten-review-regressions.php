...
t610has('plugin 1.2.7',$bootstrap,'Version: 1.2.7');
t610has('runtime 1.2.7',$contracts,"RUNTIME_VERSION                 = '1.2.7'");
t610has('core schema unchanged',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
t610has('readme stable 1.2.7',$readme,'Stable tag: 1.2.7');
t610has('repository readme 1.2.7',$repo_readme,'Runtime candidate: **1.2.7**');
t610has('status 1.2.7',$status,'Runtime candidate: **1.2.7**');
t610has('changelog 1.2.7',$changelog,'## 1.2.7 — 2026-08-11');
