...
wca_test_assert( false !== strpos( $main, 'Version: 1.0.1' ), 'plugin version is 1.0.1' );
...
wca_test_assert( false !== strpos( $all, 'Cache-Control: private, no-store' ), 'protected routes use no-store caching' );
