...
$checks = array(
	...
	'patient query scopes patient and guardian identities' => false !== strpos( $query, "_swc_patient_user_id" ) && false !== strpos( $query, "_swc_guardian_user_id" ),
	...
	'clinic schedule requires explicit owner or appointment-delegated scope' => false !== strpos( $query, '$owner_scope') && false !== strpos( $query, '$appointment_scope') && false !== strpos( $query, "delegated_clinic_ids( \$actor_user_id, 'appointments' )" ),
