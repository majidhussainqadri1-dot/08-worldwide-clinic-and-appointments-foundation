...
t510has('plugin 1.2.11',$bootstrap,'Version: 1.2.11');
t510has('runtime 1.2.11',$contracts,"RUNTIME_VERSION                 = '1.2.11'");
t510has('core schema unchanged',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
t510has('readme stable 1.2.11',$readme,'Stable tag: 1.2.11');
t510has('repository readme 1.2.11',$repo_readme,'Runtime candidate: **1.2.11**');
t510has('status 1.2.11',$status,'Runtime candidate: **1.2.11**');
t510has('changelog 1.2.11',$changelog,'## 1.2.7 — 2026-08-11');
