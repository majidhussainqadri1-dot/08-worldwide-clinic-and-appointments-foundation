...
t10has('plugin 1.2.15',$boot,'Version: 1.2.15'); t10has('runtime 1.2.15',$contracts,"RUNTIME_VERSION                 = '1.2.15'"); t10has('schema stays 3.2.0',$contracts,"SCHEMA_VERSION                  = '3.2.0'");
