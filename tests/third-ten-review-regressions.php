...
t310has('plugin header 1.2.9',$bootstrap,'Version: 1.2.9');
t310has('runtime constant 1.2.9',$bootstrap,"WCA_VERSION', '1.2.9");
t310has('contract runtime 1.2.9',$contracts,"RUNTIME_VERSION                 = '1.2.9'");
...
t310has('readme stable 1.2.9',$readme,'Stable tag: 1.2.9');
t310has('repository readme 1.2.9',$repo_readme,'Runtime candidate: **1.2.9**');
t310has('status 1.2.9',$status,'Runtime candidate: **1.2.9**');
t310has('changelog 1.2.9',$changelog,'## 1.2.9 — 2026-08-11');
