...
t310has('plugin header 1.2.7',$bootstrap,'Version: 1.2.7');
t310has('runtime constant 1.2.7',$bootstrap,"WCA_VERSION', '1.2.7");
t310has('contract runtime 1.2.7',$contracts,"RUNTIME_VERSION                 = '1.2.7'");
...
t310has('readme stable 1.2.7',$readme,'Stable tag: 1.2.7');
t310has('repository readme 1.2.7',$repo_readme,'Runtime candidate: **1.2.7**');
t310has('status 1.2.7',$status,'Runtime candidate: **1.2.7**');
t310has('changelog 1.2.7',$changelog,'## 1.2.7 — 2026-08-11');
