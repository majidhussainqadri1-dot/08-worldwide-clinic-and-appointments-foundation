...
t310has('runtime constant 1.2.4',$bootstrap,"WCA_VERSION', '1.2.4");
t310has('contract runtime 1.2.4',$contracts,"RUNTIME_VERSION                 = '1.2.4'");
...
t310has('readme stable 1.2.4',$readme,'Stable tag: 1.2.4');
t310has('repository readme 1.2.4',$repo_readme,'Runtime candidate: **1.2.4**');
t310has('status 1.2.4',$status,'Runtime candidate: **1.2.4**');
t310has('changelog 1.2.4',$changelog,'## 1.2.4 — 2026-08-11');
