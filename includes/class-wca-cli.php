...
final class WCA_CLI {
	...
	public static function health() { WP_CLI::line( wp_json_encode( WCA_Observability::health(), JSON_PRETTY_PRINT ) ); }
	...
	public static function outbox( $args, $assoc ) { $count = WCA_Outbox::process( absint( $assoc['limit'] ?? 100 ) ); WP_CLI::success( sprintf( '%d outbox messages processed.', $count ) ); }
